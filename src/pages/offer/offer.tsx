...
import {
  mapDataCityOtherPlaces,
  mapDataPointsOtherPlaces,
  otherPlacesData,
...
export const Offer: React.FC = () => {
  ...
  useEffect(() => {
    store.dispatch(fetchOfferDetailAction(id));
  }, []);
          ...
          <>
            <section className="offer">
              ...
              <div className="offer__container container">
                <div className="offer__wrapper">
                  ...
                  <section className="offer__reviews reviews">
                    {reviewsData.length && <ReviewsList list={reviewsData} />}
                    <FormReview />
                  </section>
                </div>
              </div>
              <section className="offer__map map">
                <Map
                  city={mapDataCityOtherPlaces}
                  points={mapDataPointsOtherPlaces}
                />
              </section>
            </section>
